package org.smartly.application.desktopgap.impl.app_store;
 ...
 *
 */
public class DeployerAppStore extends FileDeployer {

    public final Map<String, Object> _context;

    public DeployerAppStore(final String targetFolder,
