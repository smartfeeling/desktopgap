...
public final class AppAutorunManager {
    ...
    public void run(final IListener listener) throws IOException {
        if (!_data.isEmpty()) {
    ...
    private void run(final IListener listener, final Object item) throws IOException {
